...
@section('element','homeeditremarks')
...
<div class="card bcard mt-2 mt-lg-3">
    <div class="card-header">
      ...
      <div class="card-body px-3 pb-1">
        <form class="mt-lg-3" autocomplete="off" action="{{route('homeremarksupdate',[request()->route('id')])}}" method="post" enctype="multipart/form-data"> 
              @csrf
              @if (count($errors) > 0)
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                   ...
                   <a style='height:100px;width:100px;margin-right:15px;' target='_blank'  data-lightbox='example-1' href="{{asset('/assets/image/'.$petitionfile->file)}}"> <img class='example-image' alt='image-1'  style='height:100px;width:100px;margin-right:15px;' src="{{ asset('/assets/image/pdf.png') }}" width="50"  height="50" margin-righ="5%" alt="pic" />  </a>
                     @else 
                     <a target='_blank'  data-lightbox='example-1' href="{{asset('/assets/image/'.$petitionfile->file)}}"> <img class='example-image' alt='image-1'  style='height:100px;width:100px;margin-right:15px;' src="{{ asset('/assets/image/'.$petitionfile->file) }}" width="50"  height="50" margin-righ="5%" alt="pic" />  </a>
                     @endif 
              ...
              <div class="form-group row">
                ...
                <div class="card bcard border-1 brc-dark-l1">
                  <div class="card-body p-0">
                    <!-- <form method="post"> -->
                      <textarea id="summernote" name="remarks">{{$homepititions->remarks}}</textarea>
                    <!-- </form> -->
                  </div>
                </div>
                  </div>

                ...
                <tbody class="mt-1">
                    ...
                    <tr class="bgc-h-yellow-l4 d-style">
                        ...
                        <div class="d-none d-lg-flex">
                            <a href="{{ route('portal.roles.show',$role->id) }}" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-warning btn-a-lighter-warning">
                                <i class="fa fa-search-plus text-105">   </i>
                            </a>
                            @can('role-edit')    
                            <a href="{{ route('portal.roles.edit',$role->id) }}" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-success btn-a-lighter-success">
                            <i class="fa fa-pencil-alt"></i>
                            </a>
                            @endcan
                            <a id="delete-role" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-danger btn-a-lighter-danger">

    ...
    <div class="card bcard mt-2 mt-lg-3">
        ...
        <div class="card-body px-3 pb-1">
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" name="name" value="" onkeyup="this.value=this.value.replace(/[^A-Za-z\s]/g,'');"
                        class="form-control col-sm-8 col-md-6" id="id-form-field-1">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" onkeyup="this.value=this.value.replace(/[^A-Za-z\s]/g,'');" name="frindly_title"
                        class="form-control col-sm-8 col-md-6" id="id-form-field-1">
                </div>
            </div>

		...
		<form class="mt-lg-3" autocomplete="off" action="{{route('portal.users.update', $user->id)}}" method="post">
			...
			<div class="form-group row">
				...
				<div class="col-sm-5 col-12 tag-input-styler d-inline-flex align-items-center">
					<input type="text" value="{{$user->name}}" class="form-control form-control-lg pr-5" name="name" id="name" placeholder="Enter User Name">
				</div>
			</div>
			<div class="form-group row">
				<div class="col-sm-3 col-form-label text-sm-right pr-0">
				...
				<div class="col-sm-5 col-12 tag-input-styler d-inline-flex align-items-center">
					<input type="text" value="{{$user->email}}" class="form-control form-control-lg pr-5" id="email" name="email" placeholder="Enter User Email">
				</div>
			</div>
			<div class="form-group row">
				<div class="col-sm-3 col-form-label text-sm-right pr-0">

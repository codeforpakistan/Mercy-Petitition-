        ...
        <div class="card-body px-3 pb-1">
            ...
            <form class="mt-lg-3" action="{{ route('portal.users.password') }}" method="post" autocomplete="off">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="password" class="form-control brc-on-focus col-sm-8 col-md-6 d-inline-block"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <a href="#" id="toggle-password"
                            class="btn btn-sm border-0 btn-white ml-n5 no-underline radius-1 d-style">

		...
		<form class="mt-lg-3" autocomplete="off" action="{{route('portal.users.store')}}" method="post">
			...
			<div class="form-group row">
				...
				<div class="col-sm-5 col-12 tag-input-styler d-inline-flex align-items-center">
					<input type="text" class="form-control form-control-lg pr-5" name="name" id="name" placeholder="Enter User Name">
				</div>
			</div>
			<div class="form-group row">
				<div class="col-sm-3 col-form-label text-sm-right pr-0">
				...
				<div class="col-sm-5 col-12 tag-input-styler d-inline-flex align-items-center">
					<input type="text" class="form-control form-control-lg pr-5" id="email" name="email" placeholder="Enter User Email">
				</div>
			</div>
			<div class="form-group row">
				<div class="col-sm-3 col-form-label text-sm-right pr-0">
			...
			<div class="form-group row">
				...
				<div class="col-sm-5 col-12 tag-input-style">
					<select multiple id="roles" name="roles" id = "roles" class="select2 form-control" data-placeholder="Choose Role For User...">
			...
			<div id = "confined_in_jail"  class="form-group row d-lg-none">
				...
				<div class="col-sm-5 col-12 tag-input-style">
                      ...
                      <select name="confined_in_jail"   class="ace-select text-dark-m1 bgc-default-l5 bgc-h-warning-l3 brc-default-m3 brc-h-warning-m1">

              ...
              <tr class="bgc-h-yellow-l4 d-style">
                ...
                <td>
                  <div class="d-lg-flex">
                    ...
                    <form method="POST" id="delete-user-form" action="{{route('portal.users.destroy',$user->id)}}">
                      @csrf
                      @method('delete')
                      <input name="_method" type="hidden" value="DELETE">
                      <button id="delete-user" class=" inactive mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-danger btn-a-lighter-danger" type="submit" class="btn btn-danger btn-icon">
                      <i class="fa fa-trash-alt"></i>
              </button>
                    </form>
                  </div>

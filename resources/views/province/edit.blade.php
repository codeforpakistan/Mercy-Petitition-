...
@section('content')
    <div class="card bcard mt-2 mt-lg-3">
        ...
        <div class="card-body px-3 pb-1">
            ...
            <form action="{{ route('province.update', ['id' => $queryData->id]) }}" id="appointmentForm"
                ...
                <div class="form-group row">
                    <div class="col-sm-3 col-form-label text-sm-right pr-0">
                        <label for="PhysicalStatus" class="mb-0">province name</label>
                    </div>
                    <div class="col-sm-5 col-12 tag-input-styler d-inline-flex align-items-center">
                        <input type="text" value="{{ $queryData->province_name }}"
                            class="form-control form-control-lg pr-5" name="province_name" id="province_name"

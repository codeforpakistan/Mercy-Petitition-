...
@section('content')
    ...
    <div class="card bcard mt-2 mt-lg-3">
        ...
        <div class="card-body px-3 pb-1">
            <form class="mt-lg-3" autocomplete="off" action="{{ route('province.store') }}" method="post">
                @csrf
                @if (count($errors) > 0)
                ...
                <div class="form-group row">
                    <div class="col-sm-3 col-form-label text-sm-right pr-0">
                        <label for="province" class="mb-0">Province name</label>
                    </div>

    ...
    <div class="card bcard mt-2 mt-lg-3">
        ...
        <div class="card-body px-3 pb-1">
            <form class="mt-lg-3" autocomplete="off"
                action="{{ route('finalapprovedecision', [request()->route('id')]) }}" method="post"
            ...
            <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                          @foreach ($interiorpititions->interiorfileattachements as $petitionfile)
                        ...
                        <div class="card bcard border-1 brc-dark-l1">
                            <div class="card-body p-0">
                                ...
                                <textarea onkeyup="this.value=this.value.replace(/[^A-Za-z0-9\s]/g,'');" id="summernote"
                                    name="remarks"> {{$interiorpititions->remarks}}</textarea>
                                <!-- </form> -->
                            </div>
                        </div>

      ...
      <div class="card-body px-1 px-md-3">
        ...
        {{-- <form method="get" action="{{request()->fullUrlWithQuery(['search' => '']) }}}}">
          ...
          <div class="mb-2 mb-sm-0">
            <a class="btn btn-outline-success" href="{{ route('physicalstatus.add') }}"><i class="fa fa-fw fa-plus mr-1"></i> Add Physical Status</a>
          </div>
        </div>
              ...
              <tr class="bgc-h-yellow-l4 d-style">
                ...
                <td>
                  <div class="d-lg-flex">
                    ...
                    <a href="{{route('physicalstatus.edit',$physicalstatuses->PSid)}}" class="mx-3px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-success btn-a-lighter-success">
                      <i class="fa fa-pencil-alt"></i>
                    </a>
                    <a id="{{$physicalstatuses->PSid}}" href="#" class="btn btn-sm btn-danger del-PS" data-toggle="tooltip" title="Delete Item">

    ...
    <div class="card bcard mt-2 mt-lg-3">
        <div class="card-header">
            <h3 class="card-title text-125">
                ...
                Create New Physical Status
            </h3>
        </div>
        <div class="card-body px-3 pb-1">
            <form class="mt-lg-3" autocomplete="off" action="{{ route('physicalstatus.store') }}" method="post">
                @csrf
                @if (count($errors) > 0)
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5 col-12 tag-input-styler d-inline-flex align-items-center">
                        <input type="text" onkeyup="this.value=this.value.replace(/[^A-Za-z\s]/g,'');"
                            class="form-control form-control-lg pr-5" name="physicalstatus" id="name"

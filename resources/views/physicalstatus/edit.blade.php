  ...
  <div class="card-header">
	...
	<div class="card-body px-3 pb-1">
		{{-- <form class="mt-lg-3" autocomplete="off" action="{{route('physicalstatus.update', $queryData->PSid)}}" method="post"> --}}
            ...
            <form action="{{route('physicalstatus.update', ['id' => $queryData->PSid])}}"  id="appointmentForm" class="js-validation" method="POST" novalidate="novalidate">
			...
			<div class="form-group row">
				...
				<div class="col-sm-5 col-12 tag-input-styler d-inline-flex align-items-center">
					<input type="text" value="{{$queryData->PhysicalStatus}}" class="form-control form-control-lg pr-5" name="PhysicalStatus" id="PhysicalStatus" placeholder="Enter PhysicalStatus">
				</div>
			</div>

        ...
        <form style="margin-left:12px; margin-right:12px;padding-top:12px"
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="nationality"
                        ...
                        <option value="Pakistan" {{ $petitionsedit->nationality == 'Pakistan' ? 'selected' : ''
                            }}>Pakistan</option>
                        <option value="Afghanistan" {{ $petitionsedit->nationality == 'Afghanistan' ? 'selected' : ''
                            }}>Afghanistan</option>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="section_id"
                        ...
                        <option value="{{$section->id}}" {{$petitionsedit->select_id == $section->id ?
                            'selected="selected"' : '' }}>{{$section->undersection}}</option>
                        @endforeach
                    </select>
                </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="Date" class="form-control" value="{{$petitionsedit->warrent_date}}" name="warrent_date"

                                ...
                                <div class="d-flex justify-content-between flex-column flex-sm-row mb-3 px-2 px-sm-0">
                                    ...
                                    <div class="pos-rel ml-sm-auto mr-sm-2 order-last order-sm-0">
                                        ...
                                        <div class="pos-rel d-inline-block" style="width: calc(100% - 48px);">
                                            ...
                                            <form action="{{ route('homepetitionsearch') }}" method="get">
                                                @csrf
                                                                ...
                                                                class=" position-tr bgc-success p-1 radius-round border-2 brc-white mt-2px mr-2px"></span> --}}
                                                                    ...
                                                                    <div class="text-center mt-2">
                                                                        ...
                                                                        <span style="color: black;"
                                                                            class="text-80 text-primary text-600">Father
                                                                            Name :</span>
                                                                         ...
                                                                         <tbody>
                                                                            ...
                                                                            <tr>
                                                                             ...
                                                                             <tr class="homeDoc">
                                                                                ...
                                                                                <td class="homeremarks"><span id="homeremarks"></td>
                                                                            </tr>
                                                                            {{-- <tr class="interiorDoc">
                                                                                ...
                                                                                <td class="interiorremarks"><span id="interiorremarks"></td>
                                                                            </tr>
                                                                            <tr class="humanDoc">
                                                                                ...
                                                                                <td class="humanremarks"><span id="humanremarks"></td>

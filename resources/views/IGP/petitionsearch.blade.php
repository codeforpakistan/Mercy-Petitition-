                                            ...
                                            <div class='dropdown d-inline-block d-lg-none dd-backdrop dd-backdrop-none-lg'>
                                                ...
                                                <div class="dropdown-menu dd-slide-up dd-slide-none-lg">
                                                    <div class="dropdown-inner">
                                                        ...
                                                        <a href="{{ route('petition-forward', [$petion->id]) }}"
                                                            class=" dropdown-item mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-success btn-a-lighter-success">
                                                            <i class="fa fa-plus"></i>
                                                        </a>
                                                    </div>
                                        </td>
                                                    ...
                                                    <table class="table table-bordered table-striped table-vcenter">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td id="Confined_in_jail" class="font-w600 font-size-sm">
                                                                </td>
